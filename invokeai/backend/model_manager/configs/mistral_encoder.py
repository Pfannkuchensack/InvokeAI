"""Mistral Encoder model configuration for FLUX.2 Dev.

FLUX.2 Dev uses Mistral Small 3.1 as its text encoder instead of the
Qwen3 encoder used by FLUX.2 Klein variants.
"""
...
class MistralEncoder_Diffusers_Config(Config_Base):
    ...
    def from_model_on_disk(cls, mod: ModelOnDisk, override_fields: dict[str, Any]) -> Self:
        ...
        # Mistral uses Mistral3ForConditionalGeneration or MistralForCausalLM
        raise_for_class_name(
            config_path,
            {
